...
# 
  ...
  saveWorkbook(wb, paste0("//deqhq1/WQASSESSMENT/2018IRFiles/2018_WQAssessment/Draft List/Public Comment Data Files/", basin,"/", basin, "_Bacteria.xlsx"), 
               overwrite = TRUE)
  ...
  if(exists('chl_basin')){
    write.xlsx( chl_basin, 
                file = paste0("//deqhq1/WQASSESSMENT/2018IRFiles/2018_WQAssessment/Draft List/Public Comment Data Files/", basin,"/", basin, "_Chlorophyll.xlsx"), 
                overwrite = TRUE)
  ...
  if(exists('pH_basin')){
    write.xlsx( pH_basin, 
                file = paste0("//deqhq1/WQASSESSMENT/2018IRFiles/2018_WQAssessment/Draft List/Public Comment Data Files/", basin,"/", basin, "_pH.xlsx"), 
                overwrite = TRUE)
  ...
  if(exists('temp_basin')){
    write.xlsx( temp_basin, 
                file = paste0("//deqhq1/WQASSESSMENT/2018IRFiles/2018_WQAssessment/Draft List/Public Comment Data Files/", basin,"/", basin, "_Temperature.xlsx"), 
                overwrite = TRUE)
  ...
  saveWorkbook(wb, paste0("//deqhq1/WQASSESSMENT/2018IRFiles/2018_WQAssessment/Draft List/Public Comment Data Files/", basin,"/", basin, "_DO_Spawning.xlsx"), 
               overwrite = TRUE)
  ...
  saveWorkbook(wb, paste0("//deqhq1/WQASSESSMENT/2018IRFiles/2018_WQAssessment/Draft List/Public Comment Data Files/", basin,"/", basin, "_DO_Yearround.xlsx"), 
               overwrite = TRUE)
  ...
  saveWorkbook(wb, paste0("//deqhq1/WQASSESSMENT/2018IRFiles/2018_WQAssessment/Draft List/Public Comment Data Files/", basin,"/", basin, "_Aquatic_Life_Toxics.xlsx"), 
               overwrite = TRUE)
  ...
  saveWorkbook(wb, paste0("//deqhq1/WQASSESSMENT/2018IRFiles/2018_WQAssessment/Draft List/Public Comment Data Files/", basin,"/", basin, "_Human_Health_Toxics.xlsx"), 
               overwrite = TRUE)
